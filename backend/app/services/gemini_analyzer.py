...
- таблицу пищевой ценности (КБЖУ): ищи в изображении таблицу/блок с Б/Ж/У/ккал — OCR часто теряет структуру таблиц.
  Форматы: "Белки / Жиры / Углеводы / Энергетическая ценность", "Б: / Ж: / У: / Ккал:", цифры рядом с этими словами.
  Извлеки числовые значения на 100 г (или пересчитай на 100 г если указана другая порция).
